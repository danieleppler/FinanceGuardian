  ...
  const handle_submit = async (e) => {
    ...
    if (response.status === 201) navigate("/");
      ...
      set_form_errors({
        password: "",
        user_name: "",
        general: "Something wont wrong, plaese try again later",
      });
  };
  ...
  return (
    <div className="genearl-card-container basic-form">
      <form onSubmit={handle_submit}>
        ...
        First Name <input required name="first_name" type="text"></input>
        Last Name <input name="last_name" type="text"></input>
        Age :<input required name="age" type="number"></input>
        ...
        {form_errors.general && (
          <p className="form_error">{form_errors.general}</p>
        )}
      </form>
    </div>
  );
