...
const OverView = () => {
    ...
    return (
        <>
            <ExpensesContainer update_expenses={update_expenses} />
            <div onClick={() => { set_add_expense_popup_visibilty(true) }} className='general-btn add-expense-button'>+ Add Expense</div>
            {add_expense_popup_visibilty && <AddExpense update_expenses={update_expenses} set_update_expenses={set_update_expenses} set_add_expense_popup_visibilty={set_add_expense_popup_visibilty} />}
        </>
    )
}
